...
/*	public String[] makeDigraphs(String string) {
	...
	public String decryptPF(String key, String encryptedTxt) throws Exception {
		...
		for (index = 0; index < encryptedTxt.length() / 2; index++) { // Start at 0, loop (half the number of characters in the text) times.
			...
			//} catch (NullPointerException e) { // If the user enters a large file return error message and file name prompt
			//	System.out.println("Oops! The file you selected is too large. Please enter a smaller file, ideally around 750 bytes in size."); // Playfair works best with at least 400 chars. This particular algorithm optimised for 742 bytes. 
			//	return "exit";
			//}
		}
